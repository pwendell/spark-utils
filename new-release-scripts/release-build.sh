...
if [[ "$1" == "package" ]]; then
  ...
  make_binary_release "hadoop2.6" "-Psparkr -Psparkr-docs -Phadoop-2.6 -Phive -Phive-thriftserver -Pyarn" "3034" &
  make_binary_release "hadoop2.4-without-hive" "-Psparkr -Psparkr-docs -Phadoop-2.4 -Pyarn" "3037" &
  make_binary_release "without-hadoop" "-Psparkr -Psparkr-docs -Phadoop-provided -Pyarn" "3038" &
  wait
