...
# Source jar
pushd src/main/java
jar -cvf $SCRATCH_DIR/protobuf-java-2.4.1-sources.jar *
popd
cp target/protobuf-java-2.4.1-javadoc.jar $SCRATCH_DIR/
cp target/protobuf-java-2.4.1.jar $SCRATCH_DIR
cp pom.xml $SCRATCH_DIR/protobuf-java-2.4.1.pom

pushd $SCRATCH_DIR
gpg --sign --detach-sign -a protobuf-java-2.4.1.jar 
gpg --sign --detach-sign -a protobuf-java-2.4.1-sources.jar 
gpg --sign --detach-sign -a protobuf-java-2.4.1-javadoc.jar 
gpg --sign --detach-sign -a protobuf-java-2.4.1.pom
